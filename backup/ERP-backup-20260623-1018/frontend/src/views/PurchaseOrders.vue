                  ...
                  <table class="min-w-full text-xs">
                    ...
                    <tbody class="divide-y divide-gray-50">
                      <tr v-for="(h, i) in aiResult.history.slice(0,5)" :key="i">
                        ...
                        <td class="py-1 text-gray-400">{{ h.po_date ? String(h.po_date).slice(0,10) : '-' }}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                    ...
                    <table class="w-full text-xs">
                      ...
                      <tbody class="divide-y divide-gray-50">
                        <tr v-for="(h, i) in result.po_history" :key="'po-'+i">
                          ...
                          <td class="py-1 pr-2 text-gray-400">{{ h.po_date ? String(h.po_date).slice(0,10) : '-' }}</td>
                          <td class="py-1 text-center">
                            <button
                              type="button"
      ...
      <head>
        ...
        <style>
          ...
          * { box-sizing: border-box; }
          ...
          .items-table th, .items-table td { border: 1px solid #000; padding: 6px 8px; text-align: left; vertical-align: top; font-size: 12px; }
          .items-table th { text-align: center; font-weight: bold; font-size: 13px; background: #f8f8f8; padding: 8px; }
                  ...
                  ${formItems.value
                    .map(
                      (item, idx) =>
                        '<tr>' +
                        '<td>' + (idx + 1) + '</td>' +
                        '<td>' + (item.quantity || 0) + ' <span style="font-size:10px">' + (item.uom || '-') + '</span></td>' +
                        '<td><strong style="font-size:12px">' + (item.productName || '-') + '</strong><br/><span style="font-size:10px;color:#333">' + (item.notes || '') + '</span></td>' +
                        '<td>-</td>' +
