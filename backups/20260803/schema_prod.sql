...
--
-- Host: localhost    Database: erp_rheologi
-- ------------------------------------------------------
...
CREATE TABLE `bom_headers` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_jbox_id` (`jbox_id`),
  KEY `idx_product_id` (`product_id`),
  KEY `idx_status` (`status`),
...
CREATE TABLE `crm_notes` (
  ...
  `linked_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `linked_id` int DEFAULT NULL,
  `linked_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_by` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `document_control`
--

DROP TABLE IF EXISTS `document_control`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `engineering_inputs`
--

DROP TABLE IF EXISTS `engineering_inputs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1068 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fund_requests` (
  ...
  `cash_account_note` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
  UNIQUE KEY `request_number` (`request_number`),
...
--
-- Table structure for table `line_process_documents`
--

DROP TABLE IF EXISTS `line_process_documents`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `line_process_documents` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `mps_headers` (
  `id` int NOT NULL AUTO_INCREMENT,
  `mps_number` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `period_year` int NOT NULL,
  `period_month` int NOT NULL,
  `scheme` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'MTO',
...
--
-- Table structure for table `mrp_material_settings`
--

DROP TABLE IF EXISTS `mrp_material_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mrp_material_settings` (
  `id` int NOT NULL AUTO_INCREMENT,
  `material_id` int NOT NULL,
...
--
-- Table structure for table `mrp_planned_orders`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=1111343 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `prospects` (
  ...
  `source` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'other',
  `temperature` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'cold',
...
CREATE TABLE `purchase_order_payment_schedules` (
  ...
  `trigger_type` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual',
...
CREATE TABLE `purchase_orders` (
  ...
  `payment_term_2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `qc_analysis_requests` (
  `id` int NOT NULL AUTO_INCREMENT,
  `fpa_number` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'LP',
...
CREATE TABLE `qc_analysis_results` (
  ...
  `actual_value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `qc_specifications` (
  `id` int NOT NULL AUTO_INCREMENT,
  `product_id` int NOT NULL,
  `qc_type` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT 'Incoming',
  `parameter_id` int NOT NULL,
  `method_id` int DEFAULT NULL,
  `standard_value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=8231 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `roles` (
  ...
  UNIQUE KEY `name` (`name`),
  KEY `idx_name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=33794 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `sample_request_comments`
--

DROP TABLE IF EXISTS `sample_request_comments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sample_request_comments` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `sample_request_files`
--

DROP TABLE IF EXISTS `sample_request_files`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sample_request_files` (
  `id` int NOT NULL AUTO_INCREMENT,
  `sample_request_id` int NOT NULL,
...
CREATE TABLE `vendors` (
  ...
  `code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `supply_category` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contact_person` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
--
-- Dumping routines for database 'erp_rheologi'
--
...
-- Dump completed on 2026-08-03  4:11:18
